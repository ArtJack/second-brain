...
|---|---|---|
| `SB_MCP_HOST` | `127.0.0.1` | Bind address. Use the Tailscale IP (`100.81.78.74`) to share across devices. |
...
```
URL:    http://100.81.78.74:8848/mcp        (Tailscale — reachable from any of your devices)
